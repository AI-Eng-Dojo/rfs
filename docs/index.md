    ...
    {% for idea in ideas %}
      ...
      >
        ...
        <div
          ...
          data-vote-label="Like"
          data-voted-label="Liked today"
          data-count-label="likes on this device"
        >
          <button class="vote-button" type="button" data-vote-button>Like</button>
          <span class="vote-total"><span data-vote-count>{{ vote_count }}</span> likes on this device</span>
        </div>
        <div class="meta">
          {% if idea.date %}
